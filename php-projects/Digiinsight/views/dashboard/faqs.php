		...
		<div class="col-md-12"> 
			<?php if(isset($this->session->di_admin_logged_in) && $this->session->di_admin_logged_in){?>
				<ul class="nav nav-tabs">
					...
					<li ><a href="#addfaq">Add FAQ's</a></li>
				</ul>
				<br/>
				<div class="tab-content" style="border: 1px solid #ccc;">
					...
					<div id="analytics" class="tab-pane fade">
						...
						<div class="row" >
							...
							<div class="col-sm-10"><input type="text" id="google" class="form-control" style="width:150px; "/></div>
						</div>
						<div class="row" >
							<div class="col-sm-2"><label>Bing Code :</label></div>
							<div class="col-sm-10"><input type="text" id="bing" class="form-control" style="width:150px; "/></div>
						</div>
						<div class="row">
							<div class="col-sm-2"><label>Yahoo Code :</label></div>
							<div class="col-sm-10"><input type="text" id="yahoo" class="form-control" style="width:150px; "/></div>
						</div>
						<div class="row" >
							<div class="col-sm-2">
