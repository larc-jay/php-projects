<footer id="footer"  style="padding:2% 5% 0 5%">
 	 		...
 	 		<div class="loc-list" style="display:none;">
 	 			<ul class="lo-list-view">
 	 				<li class="locx">Abcdefghijkl</li>
 	 				<li class="locx">Abcdefg</li>
 	 				<li class="locx">Abcdef</li>
 	 			</ul>
 	 		</div>
	</footer>
	<div class="row">
    ...
    <script src="<?php echo base_url()?>_static/assets/js/ie10-viewport-bug-workaround.js"></script>
